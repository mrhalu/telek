...
try {
        ...
        const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var orcatimewisher = `𝙶𝚘𝚘𝚍 𝙽𝚒𝚐𝚑𝚝 🌌`
 }
 if(time2 < "19:00:00"){
var orcatimewisher = `𝙶𝚘𝚘𝚍 𝙴𝚟𝚎𝚗𝚒𝚗𝚐 🌃`
 }
 if(time2 < "18:00:00"){
var orcatimewisher = `𝙶𝚘𝚘𝚍 𝙴𝚟𝚎𝚗𝚒𝚗𝚐 🌃`
 }
 if(time2 < "15:00:00"){
var orcatimewisher = `𝙶𝚘𝚘𝚍 𝙰𝚏𝚝𝚎𝚛𝚗𝚘𝚘𝚗 🌅`
 }
 if(time2 < "11:00:00"){
var orcatimewisher = `𝙶𝚘𝚘𝚍 𝙼𝚘𝚛𝚗𝚒𝚗𝚐 🌄`
 }
 if(time2 < "05:00:00"){
var orcatimewisher = `𝙶𝚘𝚘𝚍 𝙼𝚘𝚛𝚗𝚒𝚗𝚐 🌄`
 } 
...
// Anti Link
        ...
        if (isgclink) return OrcaBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nYou won't be kicked by a bot because what you send is a link to this group`})
        if (isAdmins) return OrcaBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nAdmin has sent a link, admin is free to post any link`})
        if (OrcaTheCreator) return OrcaBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nOwner has sent a link, owner is free to post any link`})
        kice = m.sender
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending group link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
kice = m.sender
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending wa.me link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antiWame)
...
//antivirtex by xeon
  ...
  if (!isBotAdmins) return m.reply(mess.botAdmin)
          await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Virus Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending virus in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
  }
  }
...
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Bad Word Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} was kicked because of using bad words in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})}
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube channel link in this group`, contextInfo:{mentionedJid:[m.sendet]}}, {quoted:m})
} else {
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending instagram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending facebook link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending telegram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending tiktok link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (OrcaTheCreator) return m.reply(bvl)
        await OrcaBotInc.sendMessage(m.chat,
			...
			OrcaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
OrcaBotInc.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
OrcaBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is my handsome owner😇`, mentions: [sender]}, { quoted: repf })
}
break
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case '?': {
            ...
            xeonezy = `
┌─❖
│ 𝙷𝚊𝚒 𝙺𝚊𝚔 ${pushname} ${orcatimewisher}
└┬❖ 
┌┤✑ ${xtime} ${xdate}
│└────────────┈ ⳹
│
└─ 𝙱𝙾𝚃 𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚂𝙸        
◇ ‣ 𝚂𝙿𝙴𝙴𝙳 : ${latensie.toFixed(4)} 𝙼/𝚂
◇ ‣ 𝚁𝚄𝙽 : ${runtime(process.uptime())}
◇ ‣ 𝙽𝙰𝙼𝙴 : ${global.botname}
◇ ‣ 𝙾𝚆𝙽𝙴𝚁: ${ownernumber}
◇ ‣ 𝙼𝙾𝙳𝙴 : ${OrcaBotInc.public ? 'Public' : `Self`}
◇ ‣ 𝙷𝙾𝚂𝚃 : ${os.hostname()}
◇ ‣ 𝙾𝚂 : ${os.platform()}
│
└─ 𝚄𝚂𝙴𝚁 𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚂𝙸
...
OrcaBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNo body is allowed to send virus in this group, member who send will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
let kata =`
𝚃𝙸𝙺𝚃𝙾𝙺 𝚅𝙸𝙳𝙴𝙾 𝙳𝙾𝚆𝙻𝙾𝙰𝙳𝙴𝚁

𝙰𝚄𝚃𝙷𝙾𝚁 : ${res.result.author.nickname}
𝙳𝙴𝚂𝙲  : ${res.result.description}
𝙻𝙸𝙺𝙴 : ${res.result.statistics.likeCount} 💘

𝚂𝙸𝙻𝙰𝙺𝙰𝙽 𝙺𝙰𝙺 ${pushname}
    ...
    OrcaBotInc.sendMessage(pler, { text: q})
     ...
     replygcorca(`Done`)
      ...
      break
		...
		if (!emoji1) return replygcorca(`Example : ${prefix + command} 😅+🤔`)
		if (!emoji2) return replygcorca(`Example : ${prefix + command} 😅+🤔`)
...
break
    case 'igemoji': 
case 'instagramemoji': 
if (!q) return replygcorca("Enter emoji, maximum 1 emoji, eg?" + ` ${prefix + command} 😀`)
replygcorca(mess.wait)
emote(q, "11")
break
case 'iphoneemoji': 
if (!q) return replygcorca("Enter emoji, max 1 emoji, eg?" + ` ${prefix + command} 😀`)
replygcorca(mess.wait)
emote(q, "0")
break
case 'googleemoji': 
...
if (!OrcaTheCreator) return replygcorca(mess.owner)
if (!text) return replygcorca(`Example : ${prefix + command} xeon bihari😂`)
...
OrcaBotInc.relayMessage(m.chat, { reactionMessage }, { messageId: '🦄' })
}
break
...
𝙰𝙽𝚂𝚆𝙴𝚁 : ${response.data.choices[0].message.content}
